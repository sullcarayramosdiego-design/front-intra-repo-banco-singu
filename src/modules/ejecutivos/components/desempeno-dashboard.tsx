  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-4rem-2rem)] -m-3 md:-m-4">
      ...
      <div className="flex-1 p-4 md:p-6 space-y-6 min-w-0 relative">
        ...
        {isLoading && (
          <div className="absolute inset-0 z-[100] flex flex-col items-center justify-center bg-white/30 dark:bg-black/40 backdrop-blur-[1.5px] rounded-xl transition-all duration-300">
